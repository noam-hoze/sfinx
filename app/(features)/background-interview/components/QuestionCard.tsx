        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              placeholder="Answer"
              disabled={loading}
              className="flex-1 px-4 py-3 text-gray-400 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white disabled:opacity-50 disabled:cursor-not-allowed"
            />
