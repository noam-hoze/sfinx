        ...
        <header className="animate-slide-down border-b border-gray-200/30 bg-white/95 backdrop-blur-2xl px-6 py-4">
          <div className="flex items-center justify-between max-w-8xl mx-auto">
            ...
            <div className="flex items-center gap-4">
              ...
              {isDebugModeEnabled && (
                <button
                  onClick={() => window.dispatchEvent(new CustomEvent('toggleDebugPanel'))}
                  className={`p-2 rounded-lg transition-colors cursor-pointer ${
                    isDebugVisible ? 'bg-purple-100 text-purple-700' : 'hover:bg-gray-100 text-gray-600'
                  }`}
