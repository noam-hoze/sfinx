...
describe("calculateScore", () => {
    ...
    it("uses shared schema defaults when the scoring config row is missing", () => {
        const raw: RawScores = {
            experienceScores: [makeExperienceScore(80)],
            categoryScores: [makeCodingScore(70)],
        };
        ...
        const result = calculateScore(raw, ws, undefined);
    ...
    it("rejects non-finite problem-solving weights", () => {
