                ...
                <div className="flex items-center">
                    {session?.user && (
                        <Menu as="div" className="relative">
                            ...
                            <Menu.Items className="absolute left-1/2 -translate-x-1/2 mt-2 w-max origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none w-20">
